        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-md md:text-2xl leading-[1.6] text-black font-normal">
                {item.icon}{item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className="leading-[1.6] text-cream font-normal text-md md:text-lg">
                    {item.name}
                  </span>
